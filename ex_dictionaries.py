...
# new strings: house_number and street_name, and returns:
# "house number X on street named Y".
# The format of the input string is: numeric house number, followed by
# the street name which may contain numbers, but never by themselves,
...
def format_address(address_string):
  ...
  h_address= address_string.split()
#print(h_address)

  h_number=h_address[0]
#print(len(h_address))

  for x in range(1,len(h_address)):
      h_street += h_address[x] + " "

#print(h_number)
#print(h_street)
  # Traverse through the address parts
#for word in address_string:
  ...
  return "house number {} on street named {}".format(h_number,h_street)
